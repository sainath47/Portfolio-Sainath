  ...
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-5 justify-center">
      ...
      <div className="flex flex-col gap-1">
        <h3 className="text-3xl font-bold text-white">Sainath Reddy</h3>
        ...
        <p className="text-base text-gray-400 flex items-center gap-2">
          Phone: <span className="text-lightText">+91 8826474768</span>
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email:{" "}
          <span className="text-lightText">p.v.sainathreddy@hotmail.com</span>
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Github:{" "}
          <span className="text-lightText">https://github.com/sainath47</span>
        </p>
      </div>
      <div className="flex flex-col gap-0">
        ...
        <div className="flex gap-4">
          ...
          <span className="bannerIcon">
            <a href="mailto:p.v.sainathreddy@hotmail.com">
              <FiMail />
            </a>
          </span>
          <span className="bannerIcon">
